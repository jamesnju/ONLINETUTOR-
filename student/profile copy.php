    ...
    <div class="offcanvas offcanvas-start bg-dark " tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav">
          ...
          <li class="nav-item "><a class="nav-link m-3" href="viewenrolledcourses.php?viewenrolledcourse"><i class="fa-solid fa-graduation-cap p-2"></i>Enrolledcourses Course</a></li>
...
<div class="container-fluid">
    <div class="profile">
        <fieldset>
          ...
          <div class="links1">
            <a href="editaccount.php?edit">EditAccount</a><a href="../deleteaccount.php?deleteaccount" class="text-danger">Delete  Account</a>
          </div>
        </fieldset>
        <?php
    if(isset($_GET['edit'])){
